...
const AppointmentsHero = () => {
  ...
  const handleLoginRedirect = () => {
    // Show tooltip or redirect to login
    alert("You need to be logged in to access this feature.")
    // In a real app, you'd redirect to login page or show modal
  }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left" data-aos="fade-right" data-aos-duration="1000">
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-400 mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0">
              Get personalized care from trusted hospitals and midwives across Ghana. Schedule antenatal and postnatal appointments with ease.
            </p>
          ...
          <div className="relative flex justify-center lg:justify-end mt-8" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">
            ...
            <Image
                src="/images/appointments/ghanaian-nurse-pregnant-woman.png"
                alt="Friendly nurse or midwife attending to a pregnant woman in Ghanaian context"
                width={600}
                height={500}
