...
const HospitalCTABannerSection = () => {
  useEffect(() => {
    AOS.init({
      duration: 1000,
      once: false,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white" data-aos="fade-right">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6 leading-tight font-poppins">
              💙 Ready to find a trusted hospital near you?
            </h2>

            {/* Subheading */}
            <p className="text-xl text-white/90 mb-8 leading-relaxed font-lora">
              Join thousands of Ghanaian mothers using Obaatanpa to find quality healthcare and book appointments with ease.
            </p>
          ...
          <div className="relative" data-aos="fade-left" data-aos-delay="200">
            <div className="relative">
              <Image
                src="/images/hospitals/happy-mother-hospital-booking.png"
                alt="Happy mother successfully booking hospital appointment on phone"
                width={600}
                height={500}
              ...
              <div className="absolute -top-4 -right-4 bg-white rounded-2xl p-4 shadow-xl">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-medium text-gray-700">Hospital Found</span>
                </div>
              </div>
              
              <div className="absolute -bottom-4 -left-4 bg-white rounded-2xl p-4 shadow-xl">
                <div className="flex items-center space-x-2">
                  <MapPin className="w-4 h-4 text-[#e67d82]" />
                  <span className="text-sm font-medium text-gray-700">Appointment Booked</span>
                </div>
              </div>
...
export default HospitalCTABannerSection
