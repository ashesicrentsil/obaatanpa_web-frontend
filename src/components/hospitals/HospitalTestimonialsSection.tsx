  ...
  const testimonials = [
    {
      ...
      quote: "I found a clean, affordable maternity clinic near me within 5 minutes. The reviews from other mothers helped me make the right choice.",
      rating: 5,
      hospital: "Komfo Anokye Teaching Hospital"
    },
    {
      name: "Serwaa",
      role: "First Pregnancy",
      location: "Accra",
      image: "/images/testimonials/user2.png",
      quote: "Booking through Obaatanpa made the process so smooth. I could compare hospitals, read reviews, and book my appointment all in one place.",
      rating: 5,
    ...
    },
    {
      ...
      quote: "The hospital finder helped me discover a great maternity center I didn't know existed. The staff was amazing and the facilities were modern.",
      rating: 5,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16" data-aos="fade-up">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto font-lora">
            Real experiences from mothers who found their perfect hospital through Obaatanpa
          </p>
        </div>
            ...
            <div className="relative z-10">
              ...
              <div className="flex justify-center mb-6">
                <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-[#e67d82] to-[#7da8e6] text-white px-4 py-2 rounded-full text-sm font-semibold">
                  ...
                  <span>Found: {testimonials[currentTestimonial].hospital}</span>
                </div>
              </div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8" data-aos="fade-up" data-aos-delay="400">
          ...
          <div className="text-center">
            ...
            <div className="text-gray-600 dark:text-gray-300 font-lora">Successful Bookings</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-[#e67d82] mb-2">98%</div>
