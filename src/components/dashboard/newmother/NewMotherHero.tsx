...
const NewMotherHero = ({
  ...
  // Calculate age in months and progress
  const getAgeInfo = (ageRange: string) => {
    switch (ageRange) {
      case '0-3':
        return { months: 2, stage: '0–6 months', progress: 33, milestone: 'Starting to smile', ageText: '2 Months' }
      case '3-6':
        return { months: 4, stage: '0–6 months', progress: 67, milestone: 'Starting to babble', ageText: '4 Months' }
      case '6-12':
        return { months: 8, stage: '6–12 months', progress: 67, milestone: 'Crawling and exploring', ageText: '8 Months' }
      case '1-2':
        return { months: 15, stage: '12+ months', progress: 75, milestone: 'First words and steps', ageText: '15 Months' }
      default:
        return { months: 4, stage: '0–6 months', progress: 50, milestone: 'Growing beautifully', ageText: '4 Months' }
    }
  }

  const ageInfo = getAgeInfo(babyAge)
    ...
    <>
      ...
      <div className="bg-gradient-to-br from-pink-100 via-pink-50 to-purple-50 dark:from-pink-900/20 dark:via-pink-800/10 dark:to-purple-900/20 rounded-3xl p-8 mb-8 relative overflow-hidden">
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
          {/* Left Column - Age Info */}
          <div className="space-y-6">
            <div>
              <div className="flex items-center mb-2">
                <div className="w-3 h-3 bg-green-500 rounded-full mr-2"></div>
                <span className="text-sm font-medium text-gray-600 dark:text-gray-300">Baby's Age</span>
              </div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
                {ageInfo.stage} • {Math.round(ageInfo.progress)}% Complete
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                <div
                  ...
                  style={{ width: `${(ageInfo.months / 24) * 100}%` }}
                ></div>
              </div>
            </div>
          ...
          <div className="flex justify-center">
            <div className="relative w-64 h-64">
              {/* Baby Image */}
              <img
                src="/images/dashboard/baby-newborn.png"
                alt={`Baby at ${ageInfo.months} months`}
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="group relative">
              <div className="w-32 h-32 bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900/30 dark:to-blue-800/30 rounded-full flex flex-col items-center justify-center relative overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-lg">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <p className="text-lg font-bold text-gray-900 dark:text-white">{height} cm</p>
            ...
            <div className="group relative">
              <div className="w-32 h-32 bg-gradient-to-br from-green-100 to-green-200 dark:from-green-900/30 dark:to-green-800/30 rounded-full flex flex-col items-center justify-center relative overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-lg">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <p className="text-lg font-bold text-gray-900 dark:text-white">{weight} kg</p>
            ...
            {/* Feeds Today */}
            <div className="group relative">
              <div className="w-32 h-32 bg-gradient-to-br from-pink-100 to-pink-200 dark:from-pink-900/30 dark:to-pink-800/30 rounded-full flex flex-col items-center justify-center relative overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-lg">
                {/* Animated feeding effect */}
                <div className="absolute inset-0 opacity-30">
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-8 h-8 bg-pink-300 rounded-full animate-ping"></div>
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-6 h-6 bg-pink-400 rounded-full animate-ping delay-300"></div>
                </div>

                {/* Content */}
                <div className="relative z-10 text-center">
                  <div className="text-2xl mb-1 animate-pulse">🍼</div>
                  <p className="text-lg font-bold text-gray-900 dark:text-white">{feedsToday}</p>
                  <p className="text-xs text-gray-600 dark:text-gray-300">Feeds</p>
                </div>
            ...
            <div className="group relative">
              <div className="w-32 h-32 bg-gradient-to-br from-yellow-100 to-orange-200 dark:from-yellow-900/30 dark:to-orange-800/30 rounded-full flex flex-col items-center justify-center relative overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-lg cursor-pointer">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <p className="text-sm font-bold text-gray-900 dark:text-white">{mood}</p>
